...
../acts_build/bin/ActsExampleParticleGun  \
    -n 100                                \
    --gen-pdg 11                          \
    --gen-nparticles 25                   \
    --gen-mom-gev 0.5:10.                 \
...
../acts_build/bin/ActsExampleFatrasDD4hep                                        \
    --gen-pdg 11                                                                 \
    --dd4hep-input=../acts/thirdparty/OpenDataDetector/xml/OpenDataDetector.xml  \
    --output-csv                                                                 \
    --bf-constant-tesla 0:0:2                                                    \
    --input-dir="./"                                                             \

DIR="../../../Desktop/CERN/tra-tra/data/pdg11/pdg11-n25-0.5to10GeV-${ETA}eta/"
mv ./* ${DIR}
